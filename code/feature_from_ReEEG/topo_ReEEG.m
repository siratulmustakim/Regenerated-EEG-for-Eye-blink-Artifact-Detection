...
for j = 1:len   % total epoch/file is 1319
    ...
    fname = sprintf('ReEEG_clean%d.mat', j); % creating dynamic file nam
...
a = regen;  % regen theke a te nilam, na nileo hoto, direct regen e use kora jeto. 
...
name = sprintf('topo_ReEEG_clean.mat'); % creating dynamic file name. 
